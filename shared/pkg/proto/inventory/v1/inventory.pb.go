...
type Part struct {
	...
	Category      Category               `protobuf:"varint,8,opt,name=category,proto3,enum=inventory.v1.Category" json:"category,omitempty"`
...
func (x *UpdateStockRequest) GetUuid() string {
	if x != nil {
		return x.Uuid
	}
	return ""
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x0estock_quantity\x18\x05 \x01(\x03R\rstockQuantity\x128\n" +
	"\n" +
	"dimensions\x18\x06 \x01(\v2\x18.inventory.v1.DimensionsR\n" +
	"dimensions\x12>\n" +
	"\fmanufacturer\x18\a \x01(\v2\x1a.inventory.v1.ManufacturerR\fmanufacturer\x122\n" +
	"\bcategory\x18\b \x01(\x0e2\x16.inventory.v1.CategoryR\bcategory\x12\x12\n" +
	...
	"\rCATEGORY_WING\x10\x042\xfc\x01\n" +
	"\x10InventoryService\x12F\n" +
	"\aGetPart\x12\x1c.inventory.v1.GetPartRequest\x1a\x1d.inventory.v1.GetPartResponse\x12L\n" +
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponse\x12R\n" +
	"\vUpdateStock\x12 .inventory.v1.UpdateStockRequest\x1a!.inventory.v1.UpdateStockResponseB+Z)shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
...
var file_inventory_v1_inventory_proto_goTypes = []any{
	...
	(*UpdateStockRequest)(nil),    // 10: inventory.v1.UpdateStockRequest
	(*UpdateStockResponse)(nil),   // 11: inventory.v1.UpdateStockResponse
	nil,                           // 12: inventory.v1.Part.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 13: google.protobuf.Timestamp
}
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	1,  // 0: inventory.v1.Part.dimensions:type_name -> inventory.v1.Dimensions
	2,  // 1: inventory.v1.Part.manufacturer:type_name -> inventory.v1.Manufacturer
	...
	13, // 4: inventory.v1.Part.created_at:type_name -> google.protobuf.Timestamp
	13, // 5: inventory.v1.Part.updated_at:type_name -> google.protobuf.Timestamp
	...
	10, // 13: inventory.v1.InventoryService.UpdateStock:input_type -> inventory.v1.UpdateStockRequest
	...
	11, // 16: inventory.v1.InventoryService.UpdateStock:output_type -> inventory.v1.UpdateStockResponse
